...
class TrainOptionTrial:
    ...
    def setup(self):
        ...
        if self.params['agent_space']:
            goal_state_path = os.path.join(self.params['goal_state_dir'], 'middle_ladder_agent_space.npy')
        else:
            goal_state_path = os.path.join(self.params['goal_state_dir'], 'middle_ladder.npy')
        goal_state_pos_path = os.path.join(self.params['goal_state_dir'], 'middle_ladder_pos.txt')
